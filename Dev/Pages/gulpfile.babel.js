...
const watchScript = () => {
  gulp.watch(
    ["src/js/main.js", "src/js/components/*.js", "src/js/utils/*.js"],
    compileScriptWebpack
  );
};
...
const compile = gulp.parallel(compilePug, compileStyle, compileScriptWebpack);

const compileProd = gulp.parallel(
  compilePug,
  compileStyle,
  compileScriptWebpackProd
);
